...
package finite_state_machine.views;
...
public class FiniteStateMachine extends ViewPart {
	...
	public void createPartControl(Composite parent) {
	    ...
	    browserLData.widthHint = 1000;
	    browserLData.heightHint = 600;
	    browser.setLayoutData(browserLData);
		/*browser.setText("<html><body>"
				+ "<h4>Developed by: Swaminathan J</h2>"
				+ "<h4>Amrita Vishwa Vidyapeetham, India</h2>"
